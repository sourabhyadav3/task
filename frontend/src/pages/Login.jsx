...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(err || 'Invalid credentials. Please try again.', 'error');
    } finally {
      ...
      <div className="w-full max-w-md bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-gray-200/40 dark:border-gray-800/40 shadow-2xl rounded-3xl p-8 transition-colors duration-300">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            Enter details to manage your daily tasks.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-2xl border bg-white/50 dark:bg-gray-800/50 text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 transition-all duration-200 ${
                  errors.email
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="w-full py-3.5 px-4 bg-brand-600 hover:bg-brand-500 text-white font-bold rounded-2xl transition-all duration-200 shadow-lg shadow-brand-600/10 hover:shadow-brand-600/25 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed group text-sm"
          >
            {isSubmitting ? (
